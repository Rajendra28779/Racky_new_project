...
@Component({
  selector: 'app-supervisor-cce',
  templateUrl: './supervisor-cce.component.html',
  styleUrls: ['./supervisor-cce.component.scss']
})
export class SupervisorCceComponent implements OnInit {
  months: string;
  year: number;
  user: any;
  ...
  downloadReport() {
    ...
    TableUtil.exportListToExcel(this.report, "Out Bound Call Details", this.heading);
  }
  view(item: any) {
  ...
  saveReassignData() {
    ...
    this.callCenterExecutiveService.addReassignRemark(id, remark, this.user.userId).subscribe((data: any) => {
      if (data.status == "Success") {
        this.swal("Success", data.message, "success");
        //  this.route.navigate(['/application/supervisorcceview']);
        this.outBoundData();
