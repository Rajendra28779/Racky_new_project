...
@Component({
  selector: 'app-old-claim-progress-report',
  templateUrl: './old-claim-progress-report.component.html',
  styleUrls: ['./old-claim-progress-report.component.scss']
})
export class OldClaimProgressReportComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.headerService.setTitle('Old Claim Progress Report');
