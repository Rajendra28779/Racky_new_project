...
@Component({
  selector: 'app-extnsn-stay-approve-list',
  templateUrl: './extnsn-stay-approve-list.component.html',
  styleUrls: ['./extnsn-stay-approve-list.component.scss'],
})
export class ExtnsnStayApproveListComponent implements OnInit {
  extentionList: any = [];
  txtsearchDate: any;
  pageElement: any;
  currentPage: any;
  ...
  ngOnInit(): void {
    this.headerService.setTitle('Extension Request');
