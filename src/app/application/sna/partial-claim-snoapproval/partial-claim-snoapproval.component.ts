...
@Component({
  selector: 'app-partial-claim-snoapproval',
  templateUrl: './partial-claim-snoapproval.component.html',
  styleUrls: ['./partial-claim-snoapproval.component.scss'],
})
export class PartialClaimSnoapprovalComponent implements OnInit {
  ...
  downloadReport(no: any) {
    ...
    if (no == 1) {
      ...
      doc.setFontSize(20);
      doc.text("Partial_Claims_SNA_Approval", 100, 15);
      doc.setFontSize(13);
      ...
      doc.save('Partial_Claims_SNA_Approval.pdf');
    }
  }
}
