...
export class ApprovedApplicationComponent implements OnInit {
  ...
  utillist: any;
  messaageslist: any;
  jsonurl = 'assets/js/_configs/approvedApplications.config.json';
  formsList: any;
  isFlag = true;
  POSTS: any;
  page: number = 1;
 ...
 // elementTo:any = 0;
  ...
  getApplList(formID: any) {
    let param = { itemId: formID, pendingAt: this.userRole, pageType: 'app', profileId:0 ,serviceId:0,
  ...
  searchData(){
    ...
    this.param = { itemId: this.formID, pendingAt: this.userRole, pageType: 'app', profileId:0,serviceId:0,
