...
@Component({
  selector: 'app-application-grievance-summary',
  templateUrl: './application-grievance-summary.component.html',
  styleUrls: ['./application-grievance-summary.component.scss']
})
export class ApplicationGrievanceSummaryComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   if( this.url.includes('192.168.10.46')){
    ...
    console.log("Request Data:" + this.dataRequest)
    if (
...
pageItemChange() {
  ...
  downloadReport() {
    ...
    TableUtil.exportListToExcelWithFilter(this.report, 'Grievance_application_GO', this.heading, filter);
  }
  ...
  downloadPdf() {
      ...
      doc.text("Grievance_application_GO", 110, 50);
      ...
      doc.save('Grievance_application_GO.pdf');
  }
  convertDate(date) {
