...
@Component({
  selector: 'app-cpdconfigurationdetails',
  templateUrl: './cpdconfigurationdetails.component.html',
  styleUrls: ['./cpdconfigurationdetails.component.scss']
})

export class CpdconfigurationdetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.getStateList();
    this.headerService.setTitle("View CPD Mapping");
    this.currentPage = 1;
