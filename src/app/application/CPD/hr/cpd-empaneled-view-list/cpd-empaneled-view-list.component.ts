...
declare let $: any;
@Component({
  selector: 'app-cpd-empaneled-view-list',
  templateUrl: './cpd-empaneled-view-list.component.html',
  styleUrls: ['./cpd-empaneled-view-list.component.scss']
})
export class CpdEmpaneledViewListComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.headerService.setTitle('View Approved Application');
  ...
  downloadReport() {
    ...
    TableUtil.exportListToExcelWithFilterforadmin(this.reportExcel, "View Approved_Application List", this.heading, filter1);
  }
  ...
  downloadPdf() {
    ...
    doc.text('View Approved_Application', 100, 22);
    doc.setLineWidth(0.7);
    doc.line(100, 23, 143, 23);
    autoTable(doc, {
    ...
    doc.save('View_Approved_Application.pdf');
  }
