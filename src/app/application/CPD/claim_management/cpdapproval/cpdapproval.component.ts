/*
 * CPD Approval :08.09.2022
 * @Author Ipsita Shaw, Sambit Kumar Pradhna
 */
...
@Component({
  selector: 'app-cpdapproval',
  templateUrl: './cpdapproval.component.html',
  styleUrls: ['./cpdapproval.component.scss']
})
export class CpdapprovalComponent implements OnInit {
  ...
  downloadReport(type: any) {
    ...
    if (type == 'excel') {
      ...
      TableUtil.exportListToExcel(report, "CPD Approval List", heading);
    } else if (type == 'pdf') {
      if (this.claimlist.length > 0) {
        ...
        doc.text('CPD Approval List', 220, 30);
        doc.setFontSize(12);
        ...
        doc.save('CPD Approval List.pdf');
      } else {
