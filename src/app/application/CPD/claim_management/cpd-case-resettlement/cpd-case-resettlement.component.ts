...
declare let $: any;
@Component({
  selector: 'app-cpd-case-resettlement',
  templateUrl: './cpd-case-resettlement.component.html',
  styleUrls: ['./cpd-case-resettlement.component.scss']
})
export class CpdCaseResettlementComponent implements OnInit {
  constructor(
  ...
  ngOnInit(): void {
    this.headerService.setTitle('Case Re-Settlement Application');
  ...
  getCaseList() {
    ...
    this.allocateService.getCPDResettlementCase(requestData).subscribe(
      (response) => {
  ...
  onAction(id: any, urn: any, caseNo: any) {
    ...
    this.route.navigate(['/application/cpdcaseresettlementaction']);
  }
}
