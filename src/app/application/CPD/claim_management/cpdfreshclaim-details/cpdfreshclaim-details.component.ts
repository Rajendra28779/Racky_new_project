...
@Component({
  selector: 'app-cpdfreshclaim-details',
  templateUrl: './cpdfreshclaim-details.component.html',
  styleUrls: ['./cpdfreshclaim-details.component.scss'],
})
export class CpdfreshclaimDetailsComponent implements OnInit {
  userdetailsByid: any = [];
