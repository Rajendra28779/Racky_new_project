...
@Component({
  selector: 'app-cpd-case-reconsider-action',
  templateUrl: './cpd-case-reconsider-action.component.html',
  styleUrls: ['./cpd-case-reconsider-action.component.scss']
})
export class CpdCaseReconsiderActionComponent implements OnInit {
  user: any;
  data: any;
  caseId: any;
  caseNo: any;
  ...
  ngOnInit(): void {
    this.headerService.setTitle('Case for CPD Re-Consider');
    ...
    this.getCPDConsiderCaseDetails();
  }
  responseData: any;
  patientDetails: any;
  urnHistory: any = [];
  ...
  getCPDConsiderCaseDetails() {
    ...
    this.allocateService.getCPDConsiderCaseDetails(requestData).subscribe(
      (response) => {
        ...
        if (this.responseData.status == 'success') {
          ...
          this.packageDetails.forEach((item) => {
            ...
            item.modifiedAmount = item.approvedAmount; // Initialize modified amount
          });
  ...
  submitDetails(event) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.allocateService.cpdDraftCaseWiseAction(data).subscribe(
          (data: any) => {
            console.log(data);
            ...
            this.route.navigate(['/application/cpdcasereconsider']);
          },
          (error) => {
            console.log(error);
