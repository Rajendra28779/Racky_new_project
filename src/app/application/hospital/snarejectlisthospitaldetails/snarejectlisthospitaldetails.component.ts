...
@Component({
  selector: 'app-snarejectlisthospitaldetails',
  templateUrl: './snarejectlisthospitaldetails.component.html',
  styleUrls: ['./snarejectlisthospitaldetails.component.scss']
})
export class SnarejectlisthospitaldetailsComponent implements OnInit {
  dataClaim: any;
  getid: any;
  urnNo: any;
  authorized: any;
  ...
  ngOnInit(): void {
    this.dataClaim = JSON.parse(localStorage.getItem("actionDataforsnacompliance"));
  ...
  submitDetails(urn: any, hospitalcode: any, transactiondetailsid: any) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.pendingService.saveRejectRequestOfSNA(data)
          .subscribe((data: any) => {
            if (data.status == "Success") {
              this.swal("Success", data.message, "success");
              localStorage.removeItem("actionDataforsnacompliance");
              this.route.navigate(['/application/SNARejectedlist']);
